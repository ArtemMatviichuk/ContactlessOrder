...
namespace ContactlessOrder.DAL.Migrations
{
    ...
    [Migration("20220326195948_CompanyAndCatering")]
    partial class CompanyAndCatering
    {
            ...
            modelBuilder.Entity("ContactlessOrder.DAL.Entities.Users.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PhoneNumber = "",
                            RegistrationDate = new DateTime(2022, 3, 26, 21, 59, 48, 460, DateTimeKind.Local).AddTicks(6849)
                        });
                });
